...
export const translations = {
  ca: {
    ...
    hero: {
      title: "Creem el nou capítol de la teva llar",
      subtitle:
    ...
    services: {
      ...
      items: [
        ...
        { title: "Paleta", description: "Treballem amb professionals experimentats del sector." },
        { title: "Neteja", description: "Neteja professional de fi d'obra inclosa." },
      ],
    },
    technicalOffice: {
  ...
  es: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Albañilería", description: "Trabajamos con profesionales experimentados en el sector." },
        { title: "Limpieza", description: "Limpieza profesional de fin de obra incluida." },
      ],
    },
    technicalOffice: {
  ...
  en: {
    ...
    hero: {
      title: "We create the new chapter of your home",
      subtitle:
    ...
    services: {
      ...
      items: [
        ...
        { title: "Masonry", description: "We work with experienced professionals in the sector." },
        { title: "Cleaning", description: "Professional end-of-construction cleaning included." },
      ],
    },
    technicalOffice: {
