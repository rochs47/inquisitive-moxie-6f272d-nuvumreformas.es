  ...
  es: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Aluminio", description: "Ventanas, puertas y cerramientos de aluminio .", image: "/images/service-aluminium.jpg" },
  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Aluminum", description: "Aluminum windows, doors, and enclosures.", image: "/images/service-aluminium.jpg" },
