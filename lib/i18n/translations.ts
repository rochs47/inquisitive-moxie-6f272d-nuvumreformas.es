  ...
  ca: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Cuines", description: "Disseny i instal·lació de cuines completes.", image: "/images/service-kitchens.jpg" },
  ...
  en: {
    ...
    services: {
      ...
      subtitle: "Comprehensive solutions for every aspect of your renovation.",
        ...
        { title: "Kitchens", description: "Design and installation of complete kitchens.", image: "/images/service-kitchens.jpg" },
